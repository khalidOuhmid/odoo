...
class ContractTemplateRenderer(models.AbstractModel):
    ...
    def _prepare_context(self, contract):
        ...
        # Template configuration for signature zones
        template = contract.template_id
        template_data = {
            'name': template.name or '',
            'company_signature_label': template.company_signature_label or 'Pour BLG Groupe',
            'company_signature_sublabel': template.company_signature_sublabel or 'Lu et approuvé',
            'company_signature_position': template.company_signature_position or 'left',
            'subcontractor_signature_label': template.subcontractor_signature_label or 'Le Sous-Traitant',
            'subcontractor_signature_sublabel': template.subcontractor_signature_sublabel or 'Lu et approuvé, bon pour accord',
            'subcontractor_signature_position': template.subcontractor_signature_position or 'right',
        }
    ...
    def _prepare_wizard_context(self, wizard):
        ...
        # Template configuration for signature zones (for preview)
