...
// Register as a component (not a field widget)
// To use as a field widget, wrap it in a proper field component
registry.category("__urssaf_components__").add("urssaf_code_selector", {
