# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'views/contract_timeline_views.xml',
    ...
    'assets': {
        'web.assets_backend': [
            ...
            # Lot Selection Widget
            'construction_contract/static/src/js/lot_selection_widget.js',
            'construction_contract/static/src/xml/lot_selection_widget.xml',
            'construction_contract/static/src/scss/lot_selection_widget.scss',
            # Contract Timeline Widget
            'construction_contract/static/src/js/contract_timeline_widget.js',
            'construction_contract/static/src/xml/contract_timeline_widget.xml',
            'construction_contract/static/src/scss/contract_timeline_widget.scss',
        ],
