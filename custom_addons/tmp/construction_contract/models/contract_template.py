...
class ConstructionContractTemplate(models.Model):
    ...
    # ============================================================
    # SIGNATURE ZONE CONFIGURATION
    # ============================================================

    # Company signature zone
    company_signature_label = fields.Char(
        string='Libellé signature entreprise',
        default='Pour BLG Groupe',
        translate=True,
        help="Label displayed above the company signature zone"
    )
    company_signature_sublabel = fields.Char(
        string='Sous-libellé entreprise',
        default='Lu et approuvé',
        translate=True,
        help="Text displayed below the company signature"
    )
    company_signature_position = fields.Selection([
        ('left', 'Gauche'),
        ('right', 'Droite'),
    ], default='left', string='Position signature entreprise',
        help="Position of the company signature zone in the contract")

    # Subcontractor signature zone
    subcontractor_signature_label = fields.Char(
        string='Libellé signature sous-traitant',
        default='Le Sous-Traitant',
        translate=True,
        help="Label displayed above the subcontractor signature zone"
    )
    subcontractor_signature_sublabel = fields.Char(
        string='Sous-libellé sous-traitant',
        default='Lu et approuvé, bon pour accord',
        translate=True,
        help="Text displayed below the subcontractor signature"
    )
    subcontractor_signature_position = fields.Selection([
        ('left', 'Gauche'),
        ('right', 'Droite'),
    ], default='right', string='Position signature sous-traitant',
        help="Position of the subcontractor signature zone in the contract")
