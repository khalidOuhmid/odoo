...
class ContractCreationWizard(models.TransientModel):
    ...
    def action_create_contract(self):
        ...
        Returns:
            dict: Action to open created contract summary view
        """
        self.ensure_one()
        ...
        # Open contract summary view with recap and action buttons
        return {
            ...
            'res_id': contract.id,
            'view_mode': 'form',
            'view_id': self.env.ref('construction_contract.view_contract_summary_form').id,
            'target': 'current',
